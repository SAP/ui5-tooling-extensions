...
1.  **[Project activity](#project-activity)**: **7.94** (weight is 0.5)
...
Score: **7.94**, confidence is 10.0 (max), weight is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

43 commits in the last 3 months results to 6.62 points
5 contributors increase the score value from 6.62 to 7.94
